            ...
            <div class="header">
                ...
                <div class="_flex-container">
                    <input class="form-control me-2" type="search" placeholder="Search"
                        style="max-width: 225px;height: 40px;" id="search-teacher-name" aria-label="Search">
                    <button class="btn btn-success" type="button" id="searchTeacherByNameBtn" disabled><i
                        ...
                        <tr>
                            ...
                            <td class="flex-center p-3">
                                <div class="btn-group-vertical" role="group" aria-label="Large button group">
                                    ...
                                    <button type="button p-0 m-0"
                                        class="btn content-center btn-outline-success text-center"
                                        data-bs-toggle="modal" data-bs-target="#show-monthly-salary">
...
<!-- Modal -->
<div class="modal fade" id="show-monthly-salary" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                ...
                <table class="table table-stripped">
                    ...
                    <tbody class="no-hover">
                        <tr>
                            ...
                            <td class="p-1 m-0">
                                <input class="form-control tableInput srartTime_" type="text" value="45,000"
                                    style="max-width: 100px;" disabled>
                            </td>
                            <td class="p-1 m-0">
                                <input class="form-control tableInput srartTime_" type="number" value="2000"
                                    style="max-width: 100px;" disabled>
                            </td>
                            <td class="p-1 m-0">
                                <input class="form-control tableInput srartTime_" type="number" value="3000"
                                    style="max-width: 100px;" disabled>
                            </td>
                            <td class="p-1 m-0">
                                <input class="form-control tableInput srartTime_" type="text" value="50,000"
                        ...
                        <tr>
                            ...
                            <td class="p-1 m-0">
                                <input class="form-control tableInput srartTime_" type="number" value="2000"
                                    style="max-width: 100px;" min="0" oninput="validity.valid||(value='');"
                                    placeholder="-">
                            </td>
                            <td class="p-1 m-0">
                                <input class="form-control tableInput srartTime_" type="number" value="2000"
                            ...
                            <td class="p-1 m-0">
                                ...
                                <button class="btn btn-success content-center" style="max-width: 100px"><i
                                        class="fa-solid fa-question me-1"></i>Paid</button>
                            </td>
                        </tr>
