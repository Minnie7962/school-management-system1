@include('admin.partials._header.blade.php')
                    ...
                    <div class="container my-3">
                        ...
                        <div class="row">
                                ...
                                <select class="form-select" id="class" name="class" style="width:100%;" required>
                                    ...
                                    @include('admin.partials.select_classes.blade.php')
                                    </select>
                                    <div class="invalid-feedback">
                                    required!
                                    </div>
                                ...
                                <select class="form-select" id="section" name="section" style="width:100%;"
                                        ...
                                        <option value="null">Not Applicable</option>
                                        @include('admin.partials.selelct_section.blade.php')
                                    </select>
...
<!-- Sidebar -->
@include('admin.partials._sidebar.blade.php')
...
<div class="content">
    <!-- Navbar -->
    @include('admin.partials._navbar.blade.php')
            ...
            <div class="orders">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane" id="leave-tab" role="tabpanel" aria-labelledby="leave-tab" tabindex="0">
                       @include('admin.partials.teacher-shared.teachers-leave-tab.blade.php')
                   </div>
                </div>
            </div>
        </div>
...
@include('admin.partials._footer.blade.php');